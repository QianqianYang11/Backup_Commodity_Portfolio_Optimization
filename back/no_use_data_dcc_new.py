...
def loglike_skewt_dcc(theta, udata):
    N=14
    T=6329
    llf = np.zeros((T,1))
    dist =  sst(rets, res)
...
dcc_corr.to_excel('D:/2023semester/Lund University/thesis/test_dcc_garch.xlsx')
...
# matrix_excel_path = 'D:/2023semester/Lund University/thesis/test-average_dcc_matrix.xlsx'
