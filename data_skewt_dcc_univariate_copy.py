...
def compute_aic_bic(log_likelihood, num_params, num_obs):
    """
    Compute AIC and BIC given log-likelihood, number of parameters, and number of observations.
    
    Parameters:
        log_likelihood (float): Log-likelihood value of the model.
        num_params (int): Number of parameters in the model.
        num_obs (int): Number of observations in the dataset.
    
    Returns:
        aic (float): Akaike Information Criterion (AIC).
        bic (float): Bayesian Information Criterion (BIC).
    """
...
log_likelihood = llf  # Replace with your actual log-likelihood value
num_params = 14  # Replace with the number of parameters in your model
num_obs = 6329  # Replace with the number of observations in your dataset

# Compute AIC and BIC
aic, bic = compute_aic_bic(log_likelihood, num_params, num_obs)
print("AIC:", aic)
print("BIC:", bic)
...
average_weights_df.to_excel(output_excel_path)
